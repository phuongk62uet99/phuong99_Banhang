...
<![endif]-->       
<link rel="shortcut icon" href="{{('public/fontend/imges/ico/favicon.ico')}}">
...
<body>
   ...
   // echo $a;
    echo "XIn chaooooooooooohhoooooooooooooooooooo";
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="#"><i class="fa fa-star"></i> Yên thích</a></li>
                    ...
                    <div class="col-sm-5">
                        ...
                        <form action="{{URL::to('/tim-kiem')}}" method="POST">
                            ...
                            <div class="search_box pull-right">
                                <input name="keywords_submit" type="text" placeholder="timf tiếm sản phẩm "/>
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <img src=" {{('public/fontend/images/pricing.jpg')}}"  class="pricing" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
